...
const MODULES_TO_ENABLE = ["CommunityTransferManager"];
...
const deploy = async (network) => {
    ...
    configurator.updateModuleAddresses({
        CommunityTransferManager: CommunityTransferManagerWrapper.contractAddress
    });
    ...
    await Promise.all([
        abiUploader.upload(CommunityTransferManagerWrapper, "modules")
    ]);
